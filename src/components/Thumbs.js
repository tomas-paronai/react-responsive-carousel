...
class Thumbs extends Component {
  ...
  getImages() {
    ...
    //   return img;
    // });
    const images = React.Children.map(this.props.children, this.recursiveImageLook);
  ...
  recursiveImageLook(item) {
    ...
    if (item.props.children) {
      return this.recursiveImageLook(item.props.children[0]);
    }
